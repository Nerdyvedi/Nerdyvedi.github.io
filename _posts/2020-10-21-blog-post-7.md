...
![**Figure 1**: Gradient descent with different learning rates [Source](http://cs231n.github.io/neural-networks-3/)](https://nerdyvedi.github.io/images/learning_rate.PNG){fig-align="left" width="600" height="400"}
...
![**Figure 2**: Gradient descent: normalized versus unnormalized level curves](https://nerdyvedi.github.io/images/normalized-vs-unnormalized.PNG){fig-align="left" width="800" height="300"}
...
![**Figure 3**: Gradient descent. An illustration of how gradient descent algorithm uses the first derivative of the loss function to follow downhill it’s minimum.](https://nerdyvedi.github.io/images/gradients.PNG){fig-align="left" width="600" height="400"}
...
![**Figure 4**: Gradient descent: batch versus mini-batch loss function](https://nerdyvedi.github.io/images/batch-vs-minibatch.PNG){fig-align="left" width="800" height="300"}
...
![**Figure 5**: Gradient descent variants' trajectory towards minimum](https://nerdyvedi.github.io/images/batch-vs-minibatch-vs-stochastic.PNG){fig-align="left" width="600" height="300"}
...
![**Figure 6**: Gradient descent fails to exploit the curvature information contained in the Hessian matrix. [Source](http://www.deeplearningbook.org/contents/numerical.html)](https://nerdyvedi.github.io/images/curvature.PNG){fig-align="left" width=400" height="400"}
...
![**Figure 7**: Gradient norm. [Source](http://www.deeplearningbook.org/contents/optimization.html)](https://nerdyvedi.github.io/images/gradient_norm.PNG){fig-align="left" width="600" height="300"}
...
![**Figure 8**: Saddle point](https://nerdyvedi.github.io/images/saddle.PNG){fig-align="left" width="600" height="300"}
